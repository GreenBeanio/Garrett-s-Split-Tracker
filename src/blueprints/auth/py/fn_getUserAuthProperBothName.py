...
from blueprints.auth.py.fn_checkAuth import checkAuth
...
def getUserAuthProperBothName(
    ...
    """
    Get the Auth Cookies from a connection and additional information
    ...
    :return: [If the authorization was successful, If the user is searching for themselves, The current User]
